...
use grpc_chat::chat_service_client::ChatServiceClient;
use grpc_chat::chat_service_server::ChatServiceServer
...
impl Movie for MovieService {
    async fn get_movies(
        ...
        let reply = grpc_movie::UserData { movies: movies };
        Ok(Response::new(reply))
    }
}
#[tokio::main]
